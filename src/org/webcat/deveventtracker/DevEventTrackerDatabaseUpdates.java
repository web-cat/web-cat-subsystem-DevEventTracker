    ...
    extends UpdateSet
{
    ...
    // ----------------------------------------------------------
    /**
     * Changes the relationship between StudentProjects and Users to be
     * between StudentProjects and UuidForUsers instead.
     *
     * @throws SQLException on error
     */
    public void updateIncrement3()
        throws SQLException
    {
    ...
    // ----------------------------------------------------------
    /**
     * Creates the table to store errors thrown by the plugin, logged, and
     * sent to the server.
     *
     * @throws SQLException on error
     */
    public void updateIncrement4()
        throws SQLException
    {
     ...
     * @throws SQLException on error
     */
    private void createProjectForAssignmentTable()
        throws SQLException
    {
     ...
     * @throws SQLException on error
     */
    private void createProjectForAssignmentStudentTable()
        throws SQLException
    {
     ...
     * @throws SQLException on error
     */
    private void createSensorDataTypeTable()
        throws SQLException
    {
     ...
     * @throws SQLException on error
     */
    private void createStudentProjectTable()
        throws SQLException
    {
     ...
     * @throws SQLException on error
     */
    private void createStudentProjectForAssignmentTable()
        throws SQLException
    {
        if (!database().hasTable("StudentProjectForAssignment"))
        {
            ...
            createIndexFor(
                "StudentProjectForAssignment", "projectForAssignmentId");
        }
    }
     ...
     * @throws SQLException on error
     */
    private void createStudentProjectStudentTable()
        throws SQLException
    {
     ...
     * @throws SQLException on error
     */
    private void createUuidForUserTable()
        throws SQLException
    {
     ...
     * @throws SQLException on error
     */
    private void createStudentProjectUuidForUserTable()
        throws SQLException
    {
     ...
     * @throws SQLException on error
     */
    private void createPluginErrorTable()
        throws SQLException
    {
